...
router.get('/study/streak', farsiController.getStreak)
router.get('/study/letters/progress', farsiController.getLetterProgress)
router.post('/study/letters/:char/:position/review', farsiController.reviewLetter)
